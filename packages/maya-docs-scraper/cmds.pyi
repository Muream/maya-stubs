...
Queryable = bool | _T
Multiuse = _T | list[_T]
Range = tuple[_T] | tuple[_T, _T]
NullableRange = Range[_T | None]
...
def addPP(attribute: str) -> list[str]: ...
def affectedNet(type: str) -> bool: ...
def affects(by: bool, type: str) -> str: ...
def aimConstraint(
...
def align(
    alignToLead: bool, coordinateSystem: str, xAxis: str, yAxis: str, zAxis: str
) -> bool: ...
def alignCtx(
    align: bool,
...
def animDisplay(
    modelUpdate: str, refAnimCurvesEditable: bool, timeCode: str, timeCodeOffset: str
) -> bool: ...
def animLayer(
    addRelatedKG: bool,
    addSelectedObjects: bool,
    affectedLayers: bool,
    affectedLayersAttribute: str,
    animCurves: bool,
    attribute: str,
    baseAnimCurves: bool,
    bestAnimLayer: bool,
...
def annotate(point: tuple[float, float, float], text: str) -> str: ...
def appHome(
    iconVisible: bool,
    instrument: str,
    setTab: str,
...
def applyMetadata(format: str, scene: bool, value: str) -> bool: ...
def applyTake(
    channel: str,
    device: str,
    filter: str,
...
def arcLenDimContext(
    exists: bool, history: bool, image1: str, image2: str, image3: str, name: str
) -> str: ...
def arcLengthDimension() -> str: ...
def arclen(caching: bool, constructionHistory: bool, nodeState: int) -> float | str: ...
def arrayMapper(
    destAttr: str, inputU: str, inputV: str, mapTo: str, target: str, type: str
) -> list[str]: ...
def art3dPaintCtx(
    accopacity: bool,
    afterStrokeCmd: str,
    ...
    painttxtattr: str,
    painttxtattrname: str,
    pfxScale: float,
    pfxWidth: float,
    pickColor: bool,
    pickValue: bool,
    playbackCursor: tuple[float, float],
    playbackPressure: float,
    ...
    rgbflood: tuple[float, float, float],
...
def artAttrCtx(
    accopacity: bool,
    activeListChangedProc: str,
    afterStrokeCmd: str,
    alphaclamp: str,
    alphaclamplower: float,
    alphaclampupper: float,
    attrSelected: str,
    beforeStrokeCmd: str,
    brushalignment: bool,
    brushfeedback: bool,
    ...
    clampupper: float,
    clear: bool,
    colorAlphaValue: float,
    colorRGBAValue: tuple[float, float, float, float],
    colorRGBValue: tuple[float, float, float],
    colorRamp: str,
    colorfeedback: bool,
    colorfeedbackOverride: bool,
    colorrangelower: float,
    colorrangeupper: float,
    dataTypeIndex: int,
    ...
    minvalue: float,
    name: str,
    numericColorRamp: str,
    numericDisplayColor: tuple[float, float, float],
    numericDisplayPrecision: int,
    numericMaxColor: tuple[float, float, float],
    numericMinColor: tuple[float, float, float],
    objattrArray: str,
    objattrArrayNoMenu: str,
    opacity: float,
    outline: bool,
    outwhilepaint: bool,
    paintNodeArray: str,
    ...
    projective: bool,
    radius: float,
    rampMaxColor: tuple[float, float, float],
    rampMinColor: tuple[float, float, float],
    record: bool,
    reflection: bool,
    reflectionaboutorigin: bool,
    reflectionaxis: str,
...
def artAttrPaintVertexCtx(
    ...
    vertexColorRangeLower: float,
    vertexColorRangeUpper: float,
    whichTool: str,
    worldRadius: float,
) -> bool: ...
...
def artAttrTool(add: str, exists: str, remove: str) -> bool: ...
def artBuildPaintMenu() -> bool: ...
def artFluidAttrCtx(
    accopacity: bool,
    activeListChangedProc: str,
    afterStrokeCmd: str,
...
def artUserPaintCtx(
    ...
    finalizeCmd: str,
    fullpaths: bool,
    getArrayAttrCommand: str,
    getSurfaceCommand: str,
    getValueCommand: str,
    history: bool,
    image1: str,
    image2: str,
...
def assembly(
    ...
    activeLabel: str,
    canCreate: str,
    createOptionBoxProc: Callable[..., Any],
    ...
    label: str,
    listRepTypes: bool,
    listRepTypesProc: Callable[..., Any],
    listRepresentations: bool,
    listTypes: bool,
    name: str,
    newRepLabel: str,
    postCreateUIProc: Callable[..., Any],
    proc: Callable[..., Any],
...
def assignInputDevice(
    clutch: str, continuous: bool, device: str, immediate: bool, multiple: bool
) -> str: ...
def assignViewportFactories(
    materialFactory: str, nodeType: str, textureFactory: str
) -> bool: ...
def attachCurve(
    blendBias: float,
...
def attrColorSliderGrp(
    ...
    columnAttach: tuple[int, str, int],
...
def attrNavigationControlGrp(
    ...
    columnWidth5: tuple[int, int, int, int, int],
    columnWidth6: tuple[int, int, int, int, int, int],
    connectAttrToDropped: Callable[..., Any],
    connectNodeToDropped: Callable[..., Any],
    connectToExisting: Callable[..., Any],
    createNew: Callable[..., Any],
    defaultTraversal: Callable[..., Any],
    defineTemplate: str,
    delete: str,
    ...
    popupMenuArray: bool,
    preventOverride: bool,
    relatedNodes: Callable[..., Any],
    rowAttach: tuple[int, str, int],
    statusBarMessage: str,
    unignore: Callable[..., Any],
    useTemplate: str,
    visible: bool,
    visibleChangeCommand: Callable[..., Any],
    width: int,
...
def autoKeyframe(
    addAttr: str, characterOption: str, listAttr: bool, noReset: bool, state: bool
) -> int: ...
...
def backgroundEvaluationManager(
    interrupt: bool, mode: str, pause: bool, resume: bool
) -> bool: ...
def bakeClip(
    blend: tuple[int, int], clipIndex: int, keepOriginals: bool, name: str
) -> str: ...
def bakeDeformer(
...
def bakeResults(
    ...
    resolveWithoutLayer: str,
    sampleBy: int,
    shape: bool,
    simulation: bool,
    smart: tuple[tuple[bool, float]],
...
def blendShape(
    ...
    exclusive: str,
    export: str,
    exportTarget: tuple[int, int],
    fixedSetupData: str,
    flipTarget: tuple[int, int],
    frontOfChain: bool,
    geometry: str,
    ...
    prune: bool,
    remove: bool,
    resetTargetDelta: tuple[int, int],
    ...
    symmetrySpace: int,
    tangentSpace: bool,
    target: tuple[str, int, str, float],
    topologyCheck: bool,
    transform: str,
...
def blendShapePanel(
    ...
    needsInit: bool,
    parent: str,
    popupMenuProcedure: Callable[..., Any],
    replacePanel: str,
    tearOff: bool,
    tearOffCopy: str,
    tearOffRestore: bool,
...
def bluePencilFrame(
    ...
    moveCopy: tuple[int, int, int],
    moveToNext: bool,
    paste: bool,
    relative: bool,
    retime: int,
    scale: tuple[float, bool, int, int],
    scaleCopy: tuple[float, bool, int, int],
    stepBack: bool,
    stepForward: bool,
) -> bool: ...
def bluePencilLayer(
    ...
    delete: int,
    deleteAll: bool,
    editLocked: tuple[bool, int],
    editName: tuple[str, int],
    editOpacity: tuple[float, int],
    editState: tuple[int, int],
    editVis: tuple[bool, int],
    insert: int,
    layerState: tuple[int, int],
    move: tuple[int, int],
    moveAll: bool,
    name: tuple[str, int],
    newCamera: str,
...
def bluePencilNode(
    ...
    layerState: int,
    refresh: bool,
    refreshGhosting: bool,
) -> bool: ...
def bluePencilStroke(frameAdded: bool, layerAdded: int) -> bool: ...
def bluePencilUtil(
    adjustBrushSize: bool,
    adjustOpacity: bool,
    arrowOptions: tuple[int, int],
    arrowTool: bool,
    brushOptions: tuple[int, int, int, int, int],
    brushTool: bool,
    draw: bool,
    drawColor: tuple[int, int, int],
    ellipseOptions: tuple[int, int],
    ellipseTool: bool,
    eraserOptions: tuple[int, int, int, int, int],
    eraserTool: bool,
    ghostColorNext: tuple[int, int, int],
    ghostColorOverride: bool,
    ghostColorPrevious: tuple[int, int, int],
    ghostNext: bool,
    ghostNextCount: int,
    ghostPrevious: bool,
    ghostPreviousCount: int,
    layerManager: bool,
    layerProperties: bool,
    lineOptions: tuple[int, int],
    lineTool: bool,
    pencilOptions: tuple[int, int, int, int],
    pencilTool: bool,
    rectangleOptions: tuple[int, int],
    rectangleTool: bool,
    refreshLayerManager: bool,
    refreshTimelineDisplay: bool,
    resetTool: bool,
    textFontFamily: str,
    textOptions: tuple[int, int, str],
    textTool: bool,
    timelineFrameDisplay: int,
    transform: bool,
) -> bool: ...
def boneLattice(
    after: bool,
...
def buildBookmarkMenu(editor: str, type: str) -> bool: ...
def buildKeyframeMenu() -> bool: ...
def button(
    actOnPress: bool,
...
def cacheFileMerge(endTime: int, geometry: bool, startTime: int) -> list[float]: ...
def cacheFileTrack(
    insertTrack: int,
    lock: bool,
    mute: bool,
...
def canCreateCaddyManip() -> bool: ...
def canCreateManip() -> bool: ...
def canvas(
    annotation: str,
    backgroundColor: tuple[float, float, float],
    defineTemplate: str,
...
def changeSubdivComponentDisplayLevel(level: int, relative: bool) -> int: ...
def changeSubdivRegion(action: int, level: int) -> bool: ...
def channelBox(
    annotation: str,
...
def checkDefaultRenderGlobals() -> bool: ...
def choice(
    attribute: str,
    controlPoints: bool,
    index: int,
...
def clearCache(allNodes: bool, computed: bool, dirty: bool) -> int: ...
def clip(
    absolute: bool,
...
def cmdFileOutput(close: int, closeAll: bool, open: str, status: int) -> int: ...
...
def coarsenSubdivSelectionList() -> bool: ...
def collision(
    friction: float, name: str, offset: float, resilience: float
) -> list[str]: ...
def color(rgbColor: tuple[float, float, float], userDefined: int) -> bool: ...
def colorAtPoint(
    coordU: float,
    coordV: float,
    maxU: float,
...
def combinationShape(
    ...
    combineMethod: int,
    driverTargetIndex: int,
    driverTargetName: str,
    exist: bool,
    removeDriver: bool,
) -> int: ...
def commandEcho(
    addFilter: list[str], filter: list[str], lineNumbers: bool, state: bool
) -> bool: ...
def commandLine(
    annotation: str,
    backgroundColor: tuple[float, float, float],
...
def condition(
    delete: bool, dependency: str, initialize: bool, script: str, state: bool
) -> bool: ...
def cone(
...
def connectAttr(
    force: bool, lock: bool, nextAvailable: bool, referenceDest: str
) -> str: ...
def connectControl(
    fileName: bool, index: int, preventContextualMenu: bool, preventOverride: bool
) -> bool: ...
def connectDynamic(
...
def connectJoint(connectMode: bool, parentMode: bool) -> bool: ...
def connectionInfo(
...
def constructionHistory(toggle: bool) -> bool: ...
def container(
    addNode: list[str],
    asset: list[str],
    assetMember: str,
...
def containerProxy(fromTemplate: str, type: str) -> bool: ...
...
def contentBrowser(
    addContentPath: str,
    context: tuple[str, tuple[str], tuple[str]],
    control: bool,
    defineTemplate: str,
    docTag: str,
    exists: bool,
...
def convertIffToPsd(
    iffFileName: str, psdFileName: str, xResolution: int, yResolution: int
) -> bool: ...
def convertSolidTx(
    alpha: bool,
    antiAlias: bool,
...
def convertTessellation(allCameras: bool, camera: str) -> bool: ...
def convertUnit(fromUnit: str, toUnit: str) -> float: ...
def copyAttr(
    attribute: str,
...
def crashInfo(crashFile: bool, crashLog: bool, savedBeforeCrash: bool) -> bool: ...
def createAttrPatterns(
    patternDefinition: str, patternFile: str, patternType: str
) -> str: ...
def createDisplayLayer(
    empty: bool, makeCurrent: bool, name: str, noRecurse: bool, number: int
) -> str: ...
def createEditor(noCloseOnDelete: bool, queueForDelete: bool) -> bool: ...
def createLayeredPsdFile(
    imageFileName: tuple[str, str, str],
    psdFileName: str,
    xResolution: int,
    yResolution: int,
) -> bool: ...
def createNode(name: str, parent: str, shared: bool, skipSelect: bool) -> str: ...
def createRenderLayer(
    empty: bool, g: bool, makeCurrent: bool, name: str, noRecurse: bool, number: int
) -> str: ...
def createSubdivRegion() -> bool: ...
def ctxAbort() -> bool: ...
...
def currentCtx() -> str: ...
def currentTime(update: bool) -> int: ...
def currentTimeCtx(
    exists: bool, history: bool, image1: str, image2: str, image3: str, name: str
) -> str: ...
def currentUnit(
    angle: str, fullName: bool, linear: str, time: str, updateAnimation: bool
) -> str: ...
def curve(
    append: bool,
    bezier: bool,
    degree: float,
    editPoint: tuple[float, float, float],
    knot: float,
    name: str,
    objectSpace: bool,
    periodic: bool,
    point: tuple[float, float, float],
    pointWeight: tuple[float, float, float, float],
    replace: bool,
    worldSpace: bool,
) -> str: ...
...
def date(
    date: bool, format: str, shortDate: bool, shortTime: bool, time: bool
) -> str: ...
def dbcount(
    enabled: bool,
    file: str,
...
def dbfootprint(allObjects: bool, outputFile: str, type: str) -> str | list[str]: ...
...
def defineDataServer(device: str, server: str, undefine: bool) -> bool: ...
...
def deformerEvaluator(
    ...
    nodeInfo: bool,
    nodeStatus: bool,
    omitPassthroughs: bool,
    outlinerHash: bool,
    partition: bool,
    purge: bool,
    reuseMode: tuple[str, str],
    verbose: bool,
) -> list[str]: ...
def deformerWeights(
    attribute: str,
...
def deleteAttr(attribute: str) -> bool: ...
...
def detachDeviceAttr(
    all: bool, attribute: str, axis: str, device: str, selection: bool
) -> bool: ...
def detachSurface(
    caching: bool,
    direction: int,
...
def dgValidateCurve(allCurves: bool, verbose: bool) -> int: ...
def dgdirty(
    allPlugs: bool,
    clean: bool,
    implicit: bool,
...
def dgeval(src: bool, verbose: bool) -> bool: ...
def dgfilter(
    attribute: str,
    list: bool,
...
def dimWhen(clear: bool, false: bool, true: bool) -> bool: ...
def directKeyCtx(
    exists: bool,
    history: bool,
    image1: str,
...
def disable(value: bool) -> bool: ...
def disableIncorrectNameWarning() -> bool: ...
def disconnectAttr(nextAvailable: bool) -> str: ...
def disconnectJoint(attachHandleMode: bool, deleteHandleMode: bool) -> str: ...
def diskCache(
    append: bool,
    cacheType: str,
    close: str,
...
def displacementToPoly(findBboxOnly: bool) -> bool: ...
...
def displayCull(backFaceCulling: bool) -> bool: ...
def displayLevelOfDetail(levelOfDetail: bool) -> bool: ...
def displayPref(
...
def displayString(
    delete: bool, exists: bool, keys: bool, replace: bool, value: str
) -> bool: ...
def displaySurface(flipNormals: bool, twoSidedLighting: bool, xRay: bool) -> bool: ...
def distanceDimContext(
    exists: bool, history: bool, image1: str, image2: str, image3: str, name: str
) -> str: ...
def distanceDimension(
    endPoint: tuple[float, float, float], startPoint: tuple[float, float, float]
) -> str: ...
def doBlur(
    colorFile: str,
    length: float,
...
def dynGlobals(active: bool, listAll: bool, overSampling: int) -> int | str: ...
def dynPaintEditor(
    activeOnly: bool,
    autoSave: bool,
    camera: str,
    ...
    menu: str,
    nbImages: bool,
    newImage: tuple[int, int, float, float, float],
    paintAll: float,
    panel: str,
    parent: str,
    redrawLast: bool,
...
def dynamicLoad() -> bool: ...
def editDisplayLayerGlobals(
    baseId: int, currentDisplayLayer: str, mergeType: int, useCurrent: bool
) -> bool | int | str: ...
def editDisplayLayerMembers(
    clear: bool, fullNames: bool, noRecurse: bool, ufeObjects: bool
) -> int | list[str]: ...
def editMetadata(
    memberName: str,
    remove: bool,
...
def editRenderLayerAdjustment(
    attributeLog: bool, layer: str, nodeLog: bool, remove: bool
) -> int | list[str]: ...
...
def editRenderLayerMembers(
    fullNames: bool, noRecurse: bool, remove: bool
) -> int | list[str]: ...
def editor(
    control: bool,
    defineTemplate: str,
...
def effector(hide: bool, name: str) -> str: ...
def emit(
    attribute: str,
    floatValue: float,
    object: str,
...
def enableDevice(
    apply: bool, device: str, enable: bool, monitor: bool, record: bool
) -> bool: ...
def encodeString() -> str: ...
def error(noContext: bool, showLineNumber: bool) -> bool: ...
def eval() -> Any: ...
def evalDeferred(
    evaluateNext: bool, list: bool, lowPriority: bool, lowestPriority: bool
) -> list[str]: ...
def evaluationManager(
    ...
    safeMode: bool,
) -> int | bool | list[bool] | str | list[str]: ...
def evaluator(
    clusters: bool,
    configuration: str,
    enable: bool,
...
def exactWorldBoundingBox(
    calculateExactly: bool, ignoreInvisible: bool
) -> list[float]: ...
...
def expandedSelection(depth: int, expansionType: str) -> str | list[str]: ...
def exportEdits(
...
def file(
    ...
    lockFile: bool,
    lockReference: bool,
    mapPlaceHolderNamespace: tuple[str, str],
...
def fileInfo(referenceNode: str, remove: str) -> list[str]: ...
def filePathEditor(
    attributeOnly: bool,
    attributeType: str,
    byType: str,
...
def filter(name: str, type: str) -> str: ...
...
def filterStudioImport(
    convertShellToPoly: bool,
    includeCameras: bool,
    includeLights: bool,
    transferDirectoryName: str,
) -> bool: ...
def findDeformers() -> bool: ...
def findKeyframe(
    animation: str,
    attribute: str,
    controlPoints: bool,
...
def findType(deep: bool, exact: bool, forward: bool, type: str) -> list[str]: ...
def fitBspline(
    caching: bool,
    nodeState: int,
    tolerance: float,
...
def formLayout(
    annotation: str,
    attachControl: tuple[str, str, int, str],
    attachForm: tuple[str, str, int],
    attachNone: tuple[str, str],
    attachOppositeControl: tuple[str, str, int, str],
    attachOppositeForm: tuple[str, str, int],
    attachPosition: tuple[str, str, int, int],
    backgroundColor: tuple[float, float, float],
    childArray: bool,
    defineTemplate: str,
    docTag: str,
...
def framelessDialog(
    button: str, message: str, parent: str, path: str, primary: str, title: str
) -> str: ...
def freeFormFillet(
    bias: float,
    caching: bool,
...
def getClassification(satisfies: str) -> list[str]: ...
...
def getInputDeviceRange(maxValue: bool, minValue: bool) -> list[float]: ...
def getMetadata(
    dataType: bool,
...
def getParticleAttr(array: bool, attribute: str, object: str) -> list[float]: ...
def getRenderDependencies() -> str: ...
def getRenderTasks(camera: str, renderLayer: str) -> list[str]: ...
def ghosting(
    action: str,
    ...
    resetAll: bool,
    useDriver: bool,
) -> bool | float | list[float] | list[int] | str | list[str]: ...
def glRender(
...
def goal(goal: str, index: bool, useTransformAsGoal: bool, weight: float) -> str: ...
...
def headsUpDisplay(
    ...
    resetNodeChanges: str,
    scriptResult: bool,
    section: int,
    setOption: tuple[str, str],
    showGrid: bool,
    visible: bool,
) -> int | str | int | tuple[int, int]: ...
def headsUpMessage(
...
def hikGlobals(releaseAllPinning: bool) -> bool: ...
def hilite(replace: bool, toggle: bool, unHilite: bool) -> bool: ...
def hitTest() -> list[str]: ...
def hotBox(
    PaneOnlyMenus: bool,
...
def hudSliderButton(
    ...
    buttonPressCommand: Callable[..., Any],
    buttonReleaseCommand: Callable[..., Any],
    buttonShape: str,
    buttonWidth: int,
    decimalPrecision: int,
    internalPadding: int,
    ...
    padding: int,
    section: int,
    sliderDragCommand: Callable[..., Any],
    sliderIncrement: float,
    sliderLabel: str,
    sliderLabelFontSize: str,
    sliderLabelWidth: int,
    sliderLength: int,
    sliderPressCommand: Callable[..., Any],
    sliderReleaseCommand: Callable[..., Any],
    type: str,
    value: float,
    valueAlignment: str,
    valueFontSize: str,
...
def hyperGraph(
    ...
    imagePosition: tuple[float, float],
    imageScale: float,
...
def iconTextScrollList(
    ...
    itemTextColor: tuple[int, float, float, float],
    manage: bool,
    noBackground: bool,
    numberOfIcons: int,
    numberOfPopupMenus: bool,
...
def ikSolver(epsilon: float, maxIterations: int, name: str, solverType: str) -> str: ...
...
def ikSystemInfo(globalSnapHandle: bool) -> bool: ...
def ikfkDisplayMethod(display: str) -> bool: ...
...
def inViewEditor(visible: bool) -> bool: ...
def inViewMessage(
    alpha: float,
    assistMessage: str,
    backColor: int,
...
def inheritTransform(off: bool, on: bool, preserve: bool, toggle: bool) -> bool: ...
def insertJoint() -> str: ...
...
def instance(leaf: bool, name: str, smartTransform: bool) -> str: ...
def instanceable(allow: bool, recursive: bool, shape: bool) -> list[bool]: ...
def instancer(
    addObject: bool,
    cycle: str,
    cycleStep: float,
...
def isConnected(ignoreUnitConversion: bool) -> bool: ...
def isDirty(connection: bool, datablock: bool) -> bool: ...
def isTrue() -> bool: ...
def isolateSelect(
    addDagObject: str,
    addSelected: bool,
...
def itemFilterType(text: str, type: bool) -> str | list[str]: ...
def joint(
    absolute: bool,
    angleX: float,
    angleY: float,
...
def jointCtx(
    ...
    jointOrientationJ: tuple[float, float, float],
    largeBoneLength: float,
    largeBoneRadius: float,
    poWeightH: float,
    priorityH: int,
    scaleCompensateJ: bool,
    scaleJ: tuple[float, float, float],
    scaleOrientationJ: tuple[float, float, float],
    secondaryAxisOrient: str,
    smallBoneLength: float,
    smallBoneRadius: float,
    snapHandleH: bool,
    solverTypeH: str,
    stickyH: str,
    symmetry: bool,
...
def jointDisplayScale(absolute: bool, ikfk: float) -> float: ...
def jointLattice(
    after: bool,
    afterReference: bool,
    before: bool,
...
def keyingGroup(
    ...
    anyMember: str,
    category: str,
    channelSetColor: tuple[float, float, float],
    channelSetColorIndex: int,
    clear: str,
    color: int,
    copy: str,
    edges: bool,
...
def lightList(add: str, remove: str) -> bool: ...
def lightlink(
    b: bool,
    hierarchy: bool,
    light: str,
...
def linearPrecision() -> bool: ...
def listAnimatable(
    active: bool, manip: bool, manipHandle: bool, shape: bool, type: bool
) -> list[str]: ...
def listAttr(
    array: bool,
    attributeType: str,
...
def listInputDeviceAxes() -> list[str]: ...
def listInputDeviceButtons() -> list[str]: ...
def listInputDevices(free: bool, primary: bool, secondary: bool) -> list[str]: ...
def listNodeTypes(exclude: str) -> list[str]: ...
...
def listSets(
    allSets: bool, extendToShape: bool, object: str, type: int
) -> list[str]: ...
def loadFluid(currentTime: bool, frame: float, initialConditions: bool) -> bool: ...
...
def loadUI(
    listTypes: bool, uiFile: str, uiString: str, verbose: bool, workingDirectory: str
) -> str: ...
def lockNode(
    ignoreComponents: bool, lock: bool, lockName: bool, lockUnpublished: bool
) -> list[bool]: ...
def loft(
    autoReverse: bool,
    caching: bool,
...
def lookThru(farClip: float, nearClip: float) -> bool: ...
def ls(
    absoluteName: bool,
    allPaths: bool,
    assemblies: bool,
...
def lsThroughFilter(
    item: str, nodeArray: bool, reverse: bool, selection: bool, sort: str
) -> list[str]: ...
def lsUI(
    cmdTemplates: bool,
    collection: bool,
...
def mayaDpiSetting(
    mode: int, realScaleValue: bool, scaleValue: float, systemDpi: bool
) -> float | int: ...
def mayaHasRenderSetup(enableCurrentSession: bool, enableDuringTests: bool) -> bool: ...
def melInfo() -> list[str]: ...
def melOptions(duplicateVariableWarnings: bool) -> bool: ...
def memory(
...
def menuEditor(
    ...
    command: tuple[str, str, int, bool],
    defineTemplate: str,
    ...
    isLanguageMel: tuple[bool, str, int],
    isObscured: bool,
...
def menuItem(
    ...
    dividerLabel: str,
    docTag: str,
    dragDoubleClickCommand: Callable[..., Any],
    dragMenuCommand: Callable[..., Any],
    echoCommand: bool,
    enable: bool,
    enableCommandRepeat: bool,
    exists: bool,
...
def mlDeformer(
    controlMaximums: bool,
    controlMinimums: bool,
    exportActive: bool,
    multiIndex: int,
    reloadModel: bool,
    vertexDeltas: str,
...
def modelEditor(
    ...
    dynamics: bool,
    editorChanged: Callable[..., Any],
    excludeObjectMask: int,
    excludeObjectPreset: str,
    excludePluginList: str,
    exists: bool,
    exposure: float,
    filter: str,
    ...
    nurbsCurves: bool,
    nurbsSurfaces: bool,
    objectFilter: Callable[..., Any],
    objectFilterList: Callable[..., Any],
    objectFilterListUI: Callable[..., Any],
    objectFilterShowInHUD: bool,
    objectFilterUI: Callable[..., Any],
...
def motionMaker(
    ...
    addGenerator: bool,
    addPathLocator: bool,
    addVisualization: bool,
    clip: str,
    endFrame: int,
    exportCharacterDefinition: str,
    exportTrainingData: str,
    generate: str,
    info: str,
    namespace: str,
...
def movIn(file: str, startTime: int) -> bool: ...
def movOut(
    comment: bool, file: str, precision: int, time: NullableRange[float]
) -> bool: ...
def move(
    absolute: bool,
    autoOrientSecondaryAxis: bool,
...
def moveVertexAlongDirection(
    direction: tuple[float, float, float],
    magnitude: float,
    normalDirection: float,
    uDirection: float,
    uvNormalDirection: tuple[float, float, float],
    vDirection: float,
) -> bool: ...
def movieInfo(
    counter: bool,
...
def multiTouch(gestures: bool, trackpad: int) -> bool: ...
def mute(disable: bool, force: bool) -> list[str]: ...
def nBase(
    clearCachedTextureMap: str, clearStart: bool, stuffStart: bool, textureToVertex: str
) -> bool: ...
def nParticle(
    attribute: str,
    cache: bool,
    ...
    gridSpacing: float,
    inherit: float,
    jitterBasePoint: tuple[float, float, float],
    jitterRadius: float,
    lowerLeft: tuple[float, float, float],
    name: str,
    numJitters: int,
    order: int,
    particleId: int,
    ...
    position: tuple[float, float, float],
    shapeName: str,
    upperRight: tuple[float, float, float],
    vectorValue: tuple[float, float, float],
) -> str: ...
def nSoft(
    convert: bool,
...
def nameField(
    ...
    isObscured: bool,
    manage: bool,
    nameChangeCommand: Callable[..., Any],
    noBackground: bool,
    numberOfPopupMenus: bool,
    object: str,
    parent: str,
...
def nodeEditor(
    ...
    connectionMinSegment: float,
    connectionOffset: float,
    connectionRoundness: float,
    connectionStyle: str,
    connectionTension: int,
    consistentNameSize: bool,
    contentsChangedCommand: Callable[..., Any],
    control: bool,
    createInfo: str,
    createNodeCommand: Callable[..., Any],
    createTab: tuple[int, tuple[str]],
    crosshairOnEdgeDragging: bool,
    customAttributeListEdit: tuple[str, tuple[str]],
    cycleHUD: bool,
    ...
    dotFormat: str,
    downstream: bool,
    duplicateTab: tuple[int, tuple[int]],
    enableOpenGL: bool,
    exists: bool,
    extendToShapes: bool,
    ...
    feedbackType: bool,
    filter: str,
    filterCreateNodeTypes: Callable[..., Any],
    focusCommand: Callable[..., Any],
    forceMainConnection: str,
    frameAll: bool,
    ...
    hasWatchpoint: bool,
    highlightConnection: str,
    highlightConnections: tuple[str, bool],
    hudMessage: tuple[str, int, float],
    ignoreAssets: bool,
    island: bool,
    keyPressCommand: Callable[..., Any],
    keyReleaseCommand: Callable[..., Any],
    layout: bool,
    layoutCommand: Callable[..., Any],
    lockMainConnection: bool,
    mainListConnection: str,
    nodeSwatchSize: str,
    nodeTitleMode: str,
    ...
    selectionConnection: str,
    setWatchpoint: bool,
    settingsChangedCallback: Callable[..., Any],
    shaderNetworks: bool,
    ...
    toolTipCommand: Callable[..., Any],
    traversalDepthLimit: int,
    unParent: bool,
    unlockMainConnection: bool,
    updateMainConnection: bool,
    upstream: bool,
...
def nodeTreeLister(
    addFavorite: str,
    addItem: tuple[str, str, Callable[..., Any]],
    addVnnItem: tuple[str, str, str, str],
    annotation: str,
    backgroundColor: tuple[float, float, float],
    clearContents: bool,
    collapsePath: str,
    ...
    popupMenuArray: bool,
    preventOverride: bool,
    refreshCommand: Callable[..., Any],
    removeFavorite: str,
    removeItem: str,
    resultsPathUnderCursor: bool,
    selectPath: str,
    setDisplayName: tuple[str, str],
    statusBarMessage: str,
    useTemplate: str,
    visible: bool,
    visibleChangeCommand: Callable[..., Any],
...
def nurbsUVSet(create: bool, useExplicit: bool) -> bool: ...
def objExists() -> bool: ...
def objectCenter(
    gl: bool, local: bool, x: bool, y: bool, z: bool
) -> float | list[float]: ...
def objectType(
    isAType: str, isType: str, tagFromType: str, typeFromTag: int, typeTag: bool
) -> bool | str: ...
def objectTypeUI(isType: str, listAll: bool, superClasses: bool) -> str: ...
def offsetCurve(
    caching: bool,
    connectBreaks: int,
    cutLoop: bool,
...
def openGLExtension(
    extension: str, renderer: bool, vendor: bool, version: bool
) -> str: ...
def openMayaPref(errlog: bool, lazyLoad: bool, oldPluginWarning: bool) -> int: ...
def optionMenu(
...
def optionVar(
    ...
    exists: str,
    floatArray: str,
    floatValue: tuple[str, float],
    floatValue2: tuple[str, float, float],
    floatValue3: tuple[str, float, float, float],
    floatValue4: tuple[str, float, float, float, float],
    floatValueAppend: tuple[str, float],
    init: bool,
    intArray: str,
    intValue: tuple[str, int],
    intValue2: tuple[str, int, int],
    intValue3: tuple[str, int, int, int],
    intValue4: tuple[str, int, int, int, int],
    intValueAppend: tuple[str, int],
    list: bool,
    listCategories: bool,
    listModified: bool,
    prefFile: str,
    remove: str,
    removeFromArray: tuple[str, int],
    stash: str,
    stringArray: str,
    stringValue: tuple[str, str],
    stringValueAppend: tuple[str, str],
    transient: bool,
    unstash: str,
    version: int,
) -> int | list[str]: ...
...
def outputWindow(show: bool) -> bool: ...
def overrideModifier(clear: bool, press: str, release: str) -> bool: ...
def paintEffectsDisplay(meshDrawEnable: bool) -> bool: ...
def pairBlend(attribute: str, input1: bool, input2: bool, node: str) -> str: ...
def palettePort(
    actualTotal: int,
    annotation: str,
    backgroundColor: tuple[float, float, float],
...
def panelConfiguration(
    addPanel: tuple[bool, str, str, str, str],
    configString: str,
    createStrings: bool,
    defaultImage: str,
    defineTemplate: str,
...
def paramDimension() -> str: ...
def paramLocator(position: bool) -> str: ...
def parent(
    absolute: bool,
    addObject: bool,
    noConnections: bool,
...
def particleRenderInfo(
    attrList: int, attrListAll: bool, name: int, renderTypeCount: bool
) -> bool: ...
def partition(addSet: str, name: str, removeSet: str, render: bool) -> str: ...
def pasteKey(
    animLayer: str,
    animation: str,
    attribute: str,
...
def pickWalk(direction: str, recurse: bool, type: str) -> list[str]: ...
def picture(
    annotation: str,
    backgroundColor: tuple[float, float, float],
    defineTemplate: str,
...
def play(
    forward: bool, playSound: bool, record: bool, sound: str, state: bool, wait: bool
) -> bool: ...
def playbackOptions(
    ...
    minTime: int,
    playbackSpeed: float,
    selectionEndTime: int,
    selectionStartTime: int,
...
def pointPosition(local: bool, world: bool) -> list[float]: ...
...
def polyAppend(
    append: tuple[tuple[float, float, float]],
    constructionHistory: bool,
    edge: int,
    hole: bool,
    name: str,
...
def polyBooleanCmd(
    addMesh: str,
    changeSmoothMesh: tuple[str, bool],
    classification: int,
    interactiveUpdate: bool,
    newInputDisplay: int,
    newInputOperation: int,
    operation: int,
    removeMesh: str,
    reorderMesh: tuple[str, int],
) -> str: ...
def polyBridgeEdge(
    bridgeOffset: int,
    caching: bool,
...
def polyCanBridgeEdge() -> bool: ...
def polyCheck(edge: bool, face: bool, faceOffset: bool, openFile: str) -> int: ...
def polyChipOff(
    attraction: float,
    caching: bool,
    constructionHistory: bool,
...
def polyClipboard(
    clear: bool, color: bool, copy: bool, paste: bool, shader: bool, uvCoordinates: bool
) -> bool: ...
def polyCloseBorder(
...
def polyCollapseTweaks(hasVertexTweaks: bool) -> bool: ...
def polyColorBlindData(
    aboveMaxColorBlue: float,
    aboveMaxColorGreen: float,
    aboveMaxColorRed: float,
    attrName: str,
    belowMinColorBlue: float,
...
def polyCreateFacet(
    ...
    hole: bool,
    name: str,
    point: tuple[tuple[float, float, float]],
    subdivision: int,
    texture: int,
) -> list[str]: ...
...
def polyCutUVCtx(
    loopSpeed: int,
    mapBordersColor: tuple[float, float, float],
    showCheckerMap: bool,
    showTextureBorders: bool,
    showUVShellColoring: bool,
    steadyStroke: bool,
    steadyStrokeDistance: float,
    symmetry: int,
) -> bool | float: ...
def polyCylinder(
    axis: tuple[float, float, float],
...
def polyDuplicateAndConnect(
    removeOriginalFromShaders: bool, renameChildren: bool
) -> bool: ...
...
def polyHole(assignHole: bool, createHistory: bool) -> bool: ...
def polyInfo(
    edgeToFace: bool,
    edgeToVertex: bool,
    faceNormals: bool,
...
def polyNormalPerVertex(
    ...
    freezeNormal: bool,
    normalX: float,
    normalXYZ: tuple[float, float, float],
    normalY: float,
    normalZ: float,
    relative: bool,
    unFreezeNormal: bool,
...
def polyOptions(
    ...
    displayItemNumbers: tuple[bool, bool, bool, bool],
    displayMapBorder: bool,
    displayMetadata: tuple[bool, bool, bool],
    displayNormal: bool,
...
def polyPinUV(
    createHistory: bool, operation: int, unpinned: bool, uvSetName: str, value: float
) -> bool: ...
def polyPipe(
    axis: tuple[float, float, float],
    caching: bool,
...
def polySelect(
    ...
    deselect: bool,
    edgeBorder: int,
    edgeBorderPath: tuple[int, int],
    edgeBorderPattern: tuple[int, int],
    edgeLoop: int,
    edgeLoopOrBorder: int,
    edgeLoopOrBorderPattern: tuple[int, int],
    edgeLoopPath: tuple[int, int],
    edgeLoopPattern: tuple[int, int],
    edgeRing: int,
    edgeRingPath: tuple[int, int],
    edgeRingPattern: tuple[int, int],
    edgeUVLoopOrBorder: int,
    everyN: int,
    extendToShell: int,
    noSelection: bool,
    replace: bool,
    shortestEdgePath: tuple[int, int],
    shortestEdgePathUV: tuple[int, int],
    shortestFacePath: tuple[int, int],
    toggle: bool,
) -> list[int]: ...
...
def polySelectCtx(
    exists: bool, image1: str, image2: str, image3: str, mode: int
) -> bool: ...
...
def polySeparate(
    caching: bool, nodeState: int, removeShells: bool, separateSpecificShell: int
) -> list[str]: ...
def polySetToFaceNormal(setUserNormal: bool) -> str: ...
def polySewEdge(
    caching: bool,
    constructionHistory: bool,
    name: str,
...
def polyShortestPathCtx(
    exists: bool, image1: str, image2: str, image3: str
) -> bool: ...
def polySlideEdge(
    absolute: bool, direction: int, edgeDirection: float, symmetry: bool
) -> bool: ...
...
def polySplit(
    ...
    adjustEdgeFlow: float,
    detachEdges: bool,
    edgepoint: tuple[int, float],
    facepoint: tuple[int, float, float, float],
    insertWithEdgeFlow: bool,
    insertpoint: tuple[int, float, tuple[float, float]],
    projectedCurve: str,
...
def polySplitCtx2(
    ...
    insertWithEdgeFlow: bool,
    snapTolerance: float,
    snappedToEdgeColor: tuple[float, float, float],
    snappedToFaceColor: tuple[float, float, float],
    snappedToMagnetColor: tuple[float, float, float],
    snappedToVertexColor: tuple[float, float, float],
) -> bool: ...
def polySplitEdge(
    caching: bool, constructionHistory: bool, name: str, nodeState: int, operation: int
) -> str: ...
def polySplitRing(
    adjustEdgeFlow: float,
    caching: bool,
...
def polyUVCoverage(uvRange: tuple[float, float, float, float]) -> list[float]: ...
def polyUVOverlap(
    nonOverlappingComponents: bool, overlappingComponents: bool
) -> list[str]: ...
def polyUVRectangle(
    caching: bool, constructionHistory: bool, name: str, nodeState: int
) -> str: ...
...
def polyUVStackSimilarShells(onlyMatch: bool, tolerance: float) -> list[str]: ...
def polyUnite(
    caching: bool,
    mergeUVSets: int,
    nodeState: int,
...
def polyUniteSkinned(
    centerPivot: bool, constructionHistory: bool, mergeUVSets: int, objectPivot: bool
) -> bool: ...
def polyUnsmooth(
    caching: bool,
    constructionHistory: bool,
...
def pose(allPoses: bool, apply: bool, name: str) -> str: ...
def poseEditor(
    control: bool,
    defineTemplate: str,
    docTag: str,
...
def preferredRenderer(fallback: str, makeCurrent: bool) -> bool: ...
def preloadRefEd(
    control: bool,
    defineTemplate: str,
    docTag: str,
...
def prepareRender(
    ...
    postRender: Callable[..., Any],
    postRenderFrame: Callable[..., Any],
    postRenderLayer: Callable[..., Any],
    preRender: Callable[..., Any],
    preRenderFrame: Callable[..., Any],
    preRenderLayer: Callable[..., Any],
    restore: bool,
    saveAssemblyConfig: bool,
    settingsUI: Callable[..., Any],
    setup: bool,
    traversalSet: str,
    traversalSetInit: Callable[..., Any],
) -> bool: ...
def profiler(
    addCategory: str,
    allCategories: bool,
...
def projectionManip(fitBBox: bool, projType: int, switchType: bool) -> bool: ...
def promptDialog(
    backgroundColor: tuple[float, float, float],
    button: str,
    cancelButton: str,
...
def psdEditTextureFile(
    addChannel: str,
    addChannelColor: tuple[str, float, float, float],
    addChannelImage: tuple[str, str],
    deleteChannel: str,
    psdFileName: str,
    snapShotImage: str,
...
def psdTextureFile(
    channelRGB: tuple[str, int, int, int, int],
    channels: tuple[str, int, bool],
    imageFileName: tuple[str, str, int],
    psdFileName: str,
...
def querySubdiv(action: int, level: int, relative: bool) -> bool: ...
...
def radioMenuItemCollection(
    defineTemplate: str, exists: bool, gl: bool, parent: str, useTemplate: str
) -> str: ...
def rampColorPort(
    annotation: str,
    backgroundColor: tuple[float, float, float],
...
def readTake(
    angle: str, device: str, frequency: float, linear: str, noTime: bool, take: str
) -> bool: ...
def rebuildCurve(
    caching: bool,
    degree: int,
...
def recordAttr(attribute: str, delete: bool) -> bool: ...
def recordDevice(
    cleanup: bool,
    data: bool,
    device: str,
...
def refineSubdivSelectionList() -> bool: ...
def refresh(
    currentView: bool, fileExtension: str, filename: str, force: bool, suspend: bool
) -> bool: ...
...
def relationship(b: bool, relationshipData: str) -> bool: ...
def reloadImage() -> bool: ...
def rememberCtxSettings() -> bool: ...
def removeJoint() -> bool: ...
def removeMultiInstance(allChildren: bool, b: bool) -> bool: ...
def rename(ignoreShape: bool, uuid: bool) -> str: ...
def renameAttr() -> str: ...
def renameUI() -> str: ...
def render(
...
def renderLayerPostProcess(keepImages: bool, sceneName: str) -> bool: ...
def renderManip(
...
def renderQualityNode(
    name: str, parent: str, shared: bool, skipSelect: bool
) -> str: ...
def renderSettings(
    camera: str,
...
def renderThumbnailUpdate(forceUpdate: str) -> bool: ...
def renderWindowEditor(
    ...
    control: bool,
    currentCamera: str,
    currentCameraRig: str,
    defineTemplate: str,
    displayImage: int,
    displayImageViewCount: int,
    displayStyle: str,
    docTag: str,
    doubleBuffer: bool,
    drawAxis: bool,
    ...
    stateString: bool,
    stereo: int,
    stereoImageOrientation: tuple[str, str],
    stereoMode: str,
    toggle: bool,
    unParent: bool,
    unlockMainConnection: bool,
...
def reorder(back: bool, front: bool, relative: int) -> bool: ...
def reorderContainer(back: bool, front: bool, relative: int) -> bool: ...
def reorderDeformers(name: str) -> bool: ...
def requires(dataType: str, nodeType: str) -> bool: ...
def reroot() -> bool: ...
def resampleFluid(
    resampleDepth: int, resampleHeight: int, resampleWidth: int
) -> bool: ...
def resetTool() -> bool: ...
def resolutionNode(name: str, parent: str, shared: bool, skipSelect: bool) -> str: ...
...
def roll(absolute: bool, degree: float, relative: bool) -> bool: ...
def rollCtx(
    alternateContext: bool,
    exists: bool,
    history: bool,
...
def rotationInterpolation(convert: str) -> bool: ...
...
def rowColumnLayout(
    ...
    columnAlign: tuple[int, str],
    columnAttach: tuple[int, str, int],
    columnOffset: tuple[int, str, int],
    columnSpacing: tuple[int, int],
    columnWidth: tuple[int, int],
    defineTemplate: str,
    docTag: str,
    dragCallback: Callable[..., Any],
    ...
    popupMenuArray: bool,
    preventOverride: bool,
    rowAlign: tuple[int, str],
    rowAttach: tuple[int, str, int],
    rowHeight: tuple[int, int],
    rowOffset: tuple[int, str, int],
    rowSpacing: tuple[int, int],
    statusBarMessage: str,
    useTemplate: str,
    visible: bool,
    visibleChangeCommand: Callable[..., Any],
...
def sampleImage(fastSample: bool, resolution: tuple[int, str]) -> bool: ...
def saveAllShelves() -> bool: ...
def saveFluid(currentTime: int, endTime: int, startTime: int) -> bool: ...
def saveImage(
    annotation: str,
    backgroundColor: tuple[float, float, float],
    currentView: bool,
...
def saveInitialState(attribute: str, saveall: bool) -> str: ...
def saveMenu() -> str: ...
...
def scaleComponents(
    pivot: tuple[float, float, float], rotation: tuple[float, float, float]
) -> bool: ...
def scaleConstraint(
    layer: str,
    maintainOffset: bool,
...
def sceneLint(issueType: str, verbose: bool) -> str | list[str]: ...
...
def scmh(absolute: bool, ignore: int, quiet: bool, relative: bool) -> bool: ...
def scriptCtx(
    allComponents: bool,
    allObjects: bool,
    animBreakdown: bool,
    ...
    facet: bool,
    field: bool,
    finalCommandScript: Callable[..., Any],
    fluid: bool,
    follicle: bool,
    forceAddSelect: bool,
    hairSystem: bool,
    ...
    sculpt: bool,
    selectHandle: bool,
    setAllowExcessCount: bool,
    setAutoComplete: bool,
    setAutoToggleSelection: bool,
    setDoneSelectionPrompt: str,
    setNoSelectionHeadsUp: str,
    setNoSelectionPrompt: str,
    setSelectionCount: int,
    setSelectionHeadsUp: str,
    setSelectionPrompt: str,
    ...
    title: str,
    toolCursorType: str,
    toolFinish: Callable[..., Any],
    toolStart: Callable[..., Any],
...
def sculptKeyCtx(
    ...
    minStrengthAll: str,
    mode: int,
    modeMinStrength: tuple[int, float],
    modeStrength: tuple[int, float],
    name: str,
    radius: float,
    reset: bool,
    strength: float,
...
def sculptMeshCacheChangeCloneSource(blendShape: str, target: str) -> bool: ...
def sculptMeshCacheCtx(
    ...
    cloneMethod: int,
    cloneShapeSource: str,
    cloneTargetSource: str,
    ...
    makeStroke: tuple[int, int, int, float, float],
    minSize: float,
    minStrength: float,
    mirror: int,
    mode: str,
    ...
    stampRandomizePosX: float,
    stampRandomizePosY: float,
    stampRandomizeRotation: float,
    stampRandomizeScale: float,
    stampRandomizeStrength: float,
    stampRotation: float,
    steadyStrokeDistance: float,
    strength: float,
    updatePlane: bool,
    ...
    wholeStroke: bool,
    wireframeAlpha: float,
    wireframeColor: tuple[float, float, float],
) -> bool: ...
def sculptTarget(
    after: bool,
    afterReference: bool,
...
def setDefaultShadingGroup() -> bool: ...
...
def setMenuMode() -> str: ...
def setNodeTypeFlag(display: bool, threadSafe: bool) -> bool: ...
def setParent(
    defineTemplate: str, menu: bool, topLevel: bool, upLevel: bool, useTemplate: str
) -> str: ...
def setParticleAttr(
    attribute: str,
    floatValue: float,
...
def setRenderPassType(defaultDataType: bool, numChannels: int, type: str) -> bool: ...
def setStartupMessage() -> bool: ...
def setToolTo() -> bool: ...
def setUITemplate(popTemplate: bool, pushTemplate: bool) -> str: ...
def setXformManip(
    showUnits: bool, suppress: bool, useRotatePivot: bool, worldSpace: bool
) -> bool: ...
def sets(
    addElement: str,
    afterFilters: bool,
...
def shadingConnection(connectionState: bool) -> bool: ...
...
def shelfButton(
    ...
    menuItemPython: int,
    menuItemWithOptionBox: tuple[str, str, str],
    noBackground: bool,
    noDefaultPopup: bool,
    numberOfPopupMenus: bool,
    overlayLabelBackColor: tuple[float, float, float, float],
...
def shelfTabLayout(
    ...
    showNewTab: bool,
    statusBarMessage: str,
    tabIcon: tuple[str, str],
    tabIconIndex: tuple[int, str],
    tabLabel: tuple[str, str],
    tabLabelIndex: tuple[int, str],
    tabPosition: str,
    tabTooltip: tuple[str, str],
    tabTooltipIndex: tuple[int, str],
    tabsClosable: bool,
    tabsVisible: bool,
    useTemplate: str,
    verticalScrollBarThickness: int,
...
def shotRipple(
    deleted: bool, endDelta: int, endTime: int, startDelta: int, startTime: int
) -> bool: ...
def shotTrack(
    insertTrack: int,
    lock: bool,
...
def showHelp(absolute: bool, docs: bool, helpTable: bool, version: bool) -> bool: ...
def showHidden(
    above: bool, allObjects: bool, below: bool, lastHidden: bool
) -> bool: ...
def showManipCtx(
    addAttr: str,
    ...
    image2: str,
    image3: str,
    incSnap: tuple[int, bool],
    incSnapRelative: tuple[int, bool],
    incSnapUI: bool,
    incSnapValue: tuple[int, float],
    iveVisible: bool,
    lockSelection: bool,
...
def showSelectionInTitle() -> bool: ...
def showShadingGroupAttrEditor() -> bool: ...
def showWindow() -> bool: ...
def simplify(
    animation: str,
    attribute: str,
...
def skeletonEmbed(
    mergedMesh: bool, segmentationMethod: int, segmentationResolution: int
) -> bool: ...
def skinBindCtx(
    about: str,
    axis: str,
    colorRamp: str,
    currentInfluence: str,
    displayInactiveMode: int,
    displayNormalized: bool,
    exists: bool,
    falloffCurve: str,
    history: bool,
...
def skinPercent(
    ...
    resetToDefault: bool,
    transform: str,
    transformMoveWeights: str,
    transformValue: tuple[str, float],
    value: bool,
...
def soloMaterial(attr: str, last: bool, node: str, unsolo: bool) -> bool: ...
def sortCaseInsensitive() -> list[str]: ...
def sortStringArray(
    ignoreCase: bool, indexArray: bool, reverse: bool, sortOrder: str
) -> list[str]: ...
def sound(
    endTime: int,
    file: str,
...
def spaceLocator(
    absolute: bool, name: str, position: tuple[float, float, float], relative: bool
) -> list[str]: ...
def sphere(
    axis: tuple[float, float, float],
    caching: bool,
...
def stereoCameraView(
    ...
    useTemplate: str,
    userNode: str,
    viewColor: tuple[float, float, float, float],
    viewObjects: bool,
    viewSelected: bool,
    viewType: bool,
    width: bool,
...
def stereoRigManager(
    addRig: tuple[str, str, str],
    cameraSetFunc: tuple[str, str],
    creationProcedure: tuple[str, str],
    defaultRig: str,
    delete: str,
...
def subdDuplicateAndConnect() -> bool: ...
def subdEditUV(
    angle: float,
    pivotU: float,
    pivotV: float,
...
def subdMatchTopology(frontOfChain: bool) -> bool: ...
def subdMirror(
    caching: bool,
    nodeState: int,
    xMirror: bool,
...
def subdToBlind(
    absolutePosition: bool, includeCreases: bool, includeZeroOffsets: bool
) -> bool: ...
def subdToPoly(
    applyMatrixToResult: bool,
    caching: bool,
    ...
    format: int,
    inSubdCVId: tuple[int, int],
    inSubdCVIdLeft: int,
    inSubdCVIdRight: int,
    maxPolys: int,
    nodeState: int,
    outSubdCVId: tuple[int, int],
    outSubdCVIdLeft: int,
...
def subdTransferUVsToCache() -> bool: ...
def subdiv(
    currentLevel: bool,
    ...
    edgeStats: bool,
    faceStats: bool,
    maxPossibleLevel: int,
    proxyMode: int,
    smallOffsets: bool,
) -> bool: ...
def subdivCrease(sharpness: bool) -> bool: ...
def subdivDisplaySmoothness(all: bool, smoothness: int) -> bool: ...
...
def suitePrefs(
    applyToSuite: str, installedAsSuite: bool, isCompleteSuite: bool
) -> bool: ...
def surface(
    degreeU: int,
    degreeV: int,
...
def surfaceShaderList(add: str, remove: str) -> bool: ...
...
def sysFile(
    copy: str, delete: bool, makeDir: bool, move: str, removeEmptyDir: bool, rename: str
) -> bool: ...
def tabLayout(
    annotation: str,
    backgroundColor: tuple[float, float, float],
...
def texManipContext(exists: bool, image1: str, image2: str, image3: str) -> str: ...
def texMoveContext(
    editPivotMode: bool,
    exists: bool,
    image1: str,
...
def textCurves(font: str, name: str, object: bool, text: str) -> list[str]: ...
def textField(
...
def textManip(visible: bool) -> bool: ...
def textScrollList(
    allItems: bool,
    ...
    annotation: str,
    append: str,
    appendPosition: tuple[int, str],
    backgroundColor: tuple[float, float, float],
    defineTemplate: str,
    deleteKeyCommand: Callable[..., Any],
    deselectAll: bool,
    deselectIndexedItem: int,
    deselectItem: str,
    docTag: str,
    doubleClickCommand: Callable[..., Any],
    dragCallback: Callable[..., Any],
    ...
    enableAll: bool,
    enableBackground: bool,
    enableIndexedItem: tuple[int, bool],
    enableItem: tuple[str, bool],
    enableKeyboardFocus: bool,
    enableUniqueTagItem: tuple[str, bool],
    exists: bool,
    font: str,
    fullPathName: bool,
    height: int,
    ...
    preventOverride: bool,
    removeAll: bool,
    removeIndexedItem: int,
    removeItem: str,
    selectCommand: Callable[..., Any],
    selectIndexedItem: int,
    selectItem: str,
    selectUniqueTagItem: str,
    showIndexedItem: int,
    statusBarMessage: str,
    uniqueTag: str,
    useTemplate: str,
...
def threadCount(numberOfThreads: int) -> bool: ...
...
def timeEditorTracks(
    activeClipWeight: int,
    activeClipWeightId: int,
    addTrack: int,
    allClips: bool,
    allTracks: bool,
...
def toggleDisplacement() -> bool: ...
def toggleWindowVisibility() -> bool: ...
def tolerance(angular: float, linear: float) -> bool: ...
def toolBar(
    allowedArea: str,
    annotation: str,
    area: str,
...
def toolButton(
    ...
    toolArray: bool,
    toolCount: bool,
    toolImage1: tuple[str, str],
    toolImage2: tuple[str, str],
    toolImage3: tuple[str, str],
    useTemplate: str,
    version: str,
    visible: bool,
    visibleChangeCommand: Callable[..., Any],
...
def toolDropped() -> bool: ...
def toolHasOptions() -> bool: ...
...
def track(
    down: float, left: float, right: float, upDistance01: float, upDistance02: float
) -> bool: ...
def trackCtx(
    alternateContext: bool,
    exists: bool,
...
def transferShadingSets(sampleSpace: int, searchMethod: int) -> bool: ...
def transformCompare(root: bool) -> int: ...
def transformLimits(
...
def treeView(
    ...
    buttonErase: tuple[str, bool],
    buttonState: tuple[str, int, str],
    buttonStyle: tuple[str, int, str],
    buttonTextIcon: tuple[str, int, str],
    buttonTooltip: tuple[str, int, str],
    buttonTransparencyColor: tuple[str, int, float, float, float],
    buttonTransparencyOverride: tuple[str, int, bool],
    buttonVisible: tuple[str, int, bool],
    children: str,
    clearSelection: bool,
    contextMenuCommand: Callable[..., Any],
    defineTemplate: str,
    displayLabel: tuple[str, str],
    displayLabelSuffix: tuple[str, str],
    docTag: str,
    ...
    enable: bool,
    enableBackground: bool,
    enableButton: tuple[str, int, int],
    enableKeyboardFocus: bool,
    enableKeys: bool,
    ...
    ignoreButtonClick: tuple[str, int, int],
    image: tuple[str, int, str],
    insertItem: tuple[str, str, int],
    isItemExpanded: str,
    isLeaf: str,
    isObscured: bool,
    item: str,
    ...
    parent: str,
    popupMenuArray: bool,
    pressCommand: tuple[int, Callable[..., Any]],
    preventOverride: bool,
    removeAll: bool,
    removeItem: str,
    reverseTreeOrder: bool,
    rightPressCommand: tuple[int, Callable[..., Any]],
...
def truncateFluidCache() -> bool: ...
def truncateHairCache() -> bool: ...
def tumble(
    azimuthAngle: float,
...
def ubercam() -> str: ...
def uiTemplate(defineTemplate: str, exists: bool, useTemplate: str) -> str: ...
def unassignInputDevice(clutch: str, device: str) -> bool: ...
def undo() -> bool: ...
def undoInfo(
    chunkName: str,
    closeChunk: bool,
...
def ungroup(absolute: bool, parent: str, relative: bool, world: bool) -> bool: ...
def uniform(
    attenuation: float,
    directionX: float,
    directionY: float,
...
def unknownNode(plugin: bool, realClassName: bool, realClassTag: bool) -> list[str]: ...
def unknownPlugin(
    dataTypes: bool, list: bool, nodeTypes: bool, remove: bool, version: bool
) -> list[str]: ...
def unloadPlugin(
    addCallback: Callable[..., Any], force: bool, removeCallback: Callable[..., Any]
) -> list[str]: ...
def untangleUV(
    mapBorder: str,
...
def upAxis(axis: str, rotateView: bool) -> bool: ...
def userCtx() -> None: ...
def uvLink(
    b: bool, isValid: bool, make: bool, queryObject: str, texture: str, uvSet: str
) -> str: ...
def uvSnapshot(
    antiAliased: bool,
    blueColor: int,
...
def vectorize(
    ...
    byFrame: float,
    camera: str,
    combineFillsEdges: bool,
    currentFrame: bool,
    curveTolerance: float,
    customExtension: str,
    detailLevel: int,
    edgeColor: tuple[int, int, int],
    edgeDetail: bool,
    edgeStyle: str,
    edgeWeight: float,
    endFrame: float,
    ...
    layer: str,
    minEdgeAngle: float,
    outlinesAtIntersections: bool,
    outputFileName: str,
    pixelAspectRatio: float,
    reflectionDepth: int,
    reflections: bool,
    renderLayers: bool,
    renderOptimization: str,
    renderView: bool,
    secondaryCurveFitting: bool,
    shadows: bool,
    showBackFaces: bool,
    startFrame: float,
    svgAnimation: str,
...
def viewCamera(move: str, sideView: bool, topView: bool) -> bool: ...
def viewClipPlane(
    autoClipPlane: bool, farClipPlane: float, nearClipPlane: float, surfacesOnly: bool
) -> bool: ...
def viewFit(
    allObjects: bool,
    animate: bool,
...
def viewHeadOn() -> bool: ...
def viewLookAt(position: tuple[float, float, float]) -> bool: ...
def viewManip(
    bottomLeft: bool,
    bottomRight: bool,
    compassAngle: float,
...
def volumeBind(influence: str, name: str) -> list[str]: ...
def vortex(
    attenuation: float,
    axisX: float,
    axisY: float,
...
def waitCursor(state: bool) -> bool: ...
def walkCtx(
    alternateContext: bool,
    crouchCount: float,
    exists: bool,
...
def warning(noContext: bool, showLineNumber: bool) -> bool: ...
def webBrowser(
    annotation: str,
    back: bool,
    backgroundColor: tuple[float, float, float],
...
def webBrowserPrefs() -> None: ...
def weightsColor(
    colorRamp: str,
    deformer: str,
    falseColor: bool,
    outOfRangeColor: tuple[float, float, float],
    rampMaxColor: tuple[float, float, float],
    rampMinColor: tuple[float, float, float],
    useColorRamp: bool,
    useMaxMinColor: bool,
...
def wire(
    ...
    deformerTools: bool,
    dropoffDistance: tuple[int, float],
    dumpInfo: bool,
    envelope: float,
    exclusive: str,
    fixedSetupData: str,
...
def wireContext(
    crossingEffect: float,
    deformationOrder: str,
    dropoffDistance: float,
    envelope: float,
    exclusive: bool,
    exclusivePartition: str,
    exists: bool,
    groupWithBase: bool,
    history: bool,
    holder: bool,
...
def xformConstraint(alongNormal: int, live: bool, type: str) -> bool: ...
