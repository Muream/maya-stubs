...
def deformer(*args: List[str], edit: bool, query: bool, after: bool, afterReference: bool, before: bool, deformerTools: bool, exclusive: str, frontOfChain: bool, geometry: List[str], geometryIndices: bool, includeHiddenSelections: bool, ignoreSelected: bool, name: str, parallel: bool, prune: bool, remove: List[Tuple[]], split: bool, type: str, useComponentTags: bool) -> Any: ...
...
def displayRGBColor(*args: Tuple[str, float, float, float], query: bool, create: bool, hueSaturationValue: bool, list: bool, resetToFactory: bool, resetToSaved: bool) -> Any: ...
...
def duplicate(*args: List[str], inputConnections: bool, instanceLeaf: bool, name: str, parentOnly: bool, renameChildren: bool, returnRootsOnly: bool, smartTransform: bool, transformsOnly: bool, upstreamNodes: bool) -> Any: ...
...
def greaseRenderPlane(*args: List[str], edit: bool, query: bool, axis: Tuple[float, float, float], caching: bool, constructionHistory: bool, componentTagCreate: bool, createUVs: int, frozen: bool, height: float, name: str, nodeState: int, object: bool, subdivisionsHeight: int, subdivisionsWidth: int, subdivisionsX: int, subdivisionsY: int, texture: int, width: float) -> Any: ...
...
def lsUI(*args: List[str], controlLayouts: bool, collection: bool, cmdTemplates: bool, controls: bool, contexts: bool, dumpWidgets: bool, editors: bool, head: int, long: bool, menus: bool, menuItems: bool, numWidgets: bool, panels: bool, radioMenuItemCollections: bool, tail: int, type: List[str], windows: bool) -> Any: ...
...
def nonLinear(*args: List[str], edit: bool, query: bool, after: bool, autoParent: bool, afterReference: bool, before: bool, commonParent: bool, defaultScale: bool, deformerTools: bool, exclusive: str, frontOfChain: bool, geometry: List[str], geometryIndices: bool, includeHiddenSelections: bool, ignoreSelected: bool, name: str, parallel: bool, prune: bool, remove: List[Tuple[]], split: bool, type: str, useComponentTags: bool) -> Any: ...
...
def polyPlatonicSolid(*args: List[str], edit: bool, query: bool, axis: Tuple[float, float, float], caching: bool, constructionHistory: bool, componentTagCreate: bool, createUVs: int, frozen: bool, sideLength: float, name: str, nodeState: int, object: bool, radius: float, solidType: int, texture: int) -> Any: ...
def polyPoke(*args: List[str], edit: bool, query: bool, caching: bool, constructionHistory: bool, frozen: bool, localTranslate: Tuple[float, float, float], localTranslateX: float, localTranslateY: float, localTranslateZ: float, name: str, nodeState: int, translate: Tuple[float, float, float], translateX: float, translateY: float, translateZ: float, worldSpace: bool) -> Any: ...
def polyPrimitive(*args: List[str], edit: bool, query: bool, axis: Tuple[float, float, float], caching: bool, constructionHistory: bool, componentTagCreate: bool, createUVs: int, frozen: bool, sideLength: float, name: str, nodeState: int, object: bool, polyType: int, radius: float, texture: int) -> Any: ...
def polyPrimitiveMisc(*args, **kwargs) -> Any: ...
def polyPrism(*args: List[str], edit: bool, query: bool, axis: Tuple[float, float, float], caching: bool, constructionHistory: bool, componentTagCreate: bool, createUVs: int, frozen: bool, length: float, name: str, nodeState: int, numberOfSides: int, numderOfSides: int, object: bool, subdivisionsCaps: int, subdivisionsHeight: int, texture: int, sideLength: float) -> Any: ...
...
def showManipCtx(arg0: str, edit: bool, query: bool, history: bool, currentNodeName: bool, exists: bool, image1: str, image2: str, image3: str, incSnap: List[Tuple[int, bool]], incSnapRelative: List[Tuple[int, bool]], incSnapUI: bool, incSnapValue: List[Tuple[int, float]], lockSelection: bool, name: str, toolFinish: Callable, toggleIncSnap: bool, toolStart: Callable) -> Any: ...
...
def symbolCheckBox(arg0: str, edit: bool, query: bool, annotation: str, backgroundColor: Tuple[float, float, float], changeCommand: Callable, disableOffImage: str, dragCallback: Callable, disableOnImage: str, dropCallback: Callable, defineTemplate: str, docTag: str, enableBackground: bool, enableKeyboardFocus: bool, enable: bool, exists: bool, fullPathName: bool, height: int, highlightColor: Tuple[float, float, float], image: str, innerMargin: bool, isObscured: bool, ltVersion: str, manage: bool, noBackground: bool, numberOfPopupMenus: bool, offCommand: Callable, offImage: str, onCommand: Callable, onImage: str, parent: str, popupMenuArray: bool, preventOverride: bool, statusBarMessage: str, useTemplate: str, value: bool, visibleChangeCommand: Callable, version: str, visible: bool, width: int) -> Any: ...
...
def tension(*args: List[str], edit: bool, query: bool, after: bool, afterReference: bool, before: bool, deformerTools: bool, envelope: float, exclusive: str, frontOfChain: bool, geometry: List[str], geometryIndices: bool, includeHiddenSelections: bool, ignoreSelected: bool, inwardConstraint: float, name: str, outwardConstraint: float, parallel: bool, pinBorderVertices: bool, prune: bool, remove: List[Tuple[]], smoothingIterations: int, split: bool, smoothingStep: float, useComponentTags: bool) -> Any: ...
def testPa() -> Any: ...
...
def toolButton(arg0: str, edit: bool, query: bool, allowMultipleTools: bool, annotation: str, backgroundColor: Tuple[float, float, float], changeCommand: Callable, collection: str, doubleClickCommand: Callable, dragCallback: Callable, dropCallback: Callable, defineTemplate: str, docTag: str, enableBackground: bool, enableKeyboardFocus: bool, enable: bool, exists: bool, fullPathName: bool, height: int, highlightColor: Tuple[float, float, float], image1: str, image2: str, image3: str, isObscured: bool, imageOverlayLabel: str, ltVersion: str, manage: bool, noBackground: bool, numberOfPopupMenus: bool, offCommand: Callable, onCommand: Callable, parent: str, popupIndicatorVisible: bool, popupMenuArray: bool, preventOverride: bool, statusBarMessage: str, select: bool, style: str, tool: List[str], toolArray: bool, toolCount: bool, toolImage1: List[Tuple[str, str]], toolImage2: List[Tuple[str, str]], toolImage3: List[Tuple[str, str]], useTemplate: str, visibleChangeCommand: Callable, version: str, visible: bool, width: int) -> Any: ...
...
def workspaceControl(arg0: str, edit: bool, query: bool, closeCommand: Callable, close: bool, collapse: bool, checksPlugins: bool, deleteLater: bool, defineTemplate: str, dockToControl: Tuple[str, str], dockToMainWindow: Tuple[str, bool], dockToPanel: Tuple[str, str, bool], duplicatable: bool, exists: bool, floating: bool, height: bool, heightProperty: str, horizontal: bool, initCallback: str, initialHeight: int, initialWidth: int, label: str, loadImmediately: bool, minimumHeight: int, minimumWidth: int, r: bool, requiredControl: List[str], requiredPlugin: List[str], restore: bool, resizeHeight: int, resizeWidth: int, retain: bool, stateString: str, tabPosition: Tuple[str, bool], tabToControl: Tuple[str, int], uiScript: Callable, useTemplate: str, visibleChangeCommand: Callable, visible: bool, width: bool, widthProperty: str) -> Any: ...
