...
def texturePlacementContext(*args: Any, edit: bool = ..., query: bool = ..., exists: bool = ..., history: bool = ..., image1: Queryable[str] = ..., image2: Queryable[str] = ..., image3: Queryable[str] = ..., labelMapping: bool = ..., name: str = ...) -> Union[str, bool]:
    ...
    Args:
        ...
        image3 (Queryable[str]?): Third of three possible icons representing the tool  
                associated with the context.  
                Properties: create, query, edit
        labelMapping (bool?): Set the context to label mapping.  
                Properties: create, query, edit
