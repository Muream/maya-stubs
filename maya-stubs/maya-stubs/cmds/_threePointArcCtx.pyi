...
def threePointArcCtx(*args: Any, edit: bool = ..., query: bool = ..., degree: Queryable[int] = ..., exists: bool = ..., history: bool = ..., image1: Queryable[str] = ..., image2: Queryable[str] = ..., image3: Queryable[str] = ..., name: str = ..., spans: Queryable[int] = ...) -> Union[str, int]:
    ...
    Args:
        ...
        name (str?): If this is a tool command, name the tool appropriately.  
                Properties: create
        spans (Queryable[int]?): Default is 8.  
                Properties: create, query, edit
