...
def shadingLightRelCtx(*args: Any, edit: bool = ..., query: bool = ..., exists: bool = ..., history: bool = ..., image1: Queryable[str] = ..., image2: Queryable[str] = ..., image3: Queryable[str] = ..., name: str = ..., offCommand: Queryable[str] = ..., onCommand: Queryable[str] = ..., shadingCentric: bool = ...) -> Union[str, bool]:
    ...
    group are highlighted.  Subsequent selections result in assignments.Specifying -shadingCentric false means that the light is to be selected
