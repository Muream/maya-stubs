...
def texScaleContext(*args: Any, edit: bool = ..., query: bool = ..., editPivotMode: bool = ..., exists: bool = ..., image1: Queryable[str] = ..., image2: Queryable[str] = ..., image3: Queryable[str] = ..., position: bool = ..., preventNegativeScale: bool = ..., snap: bool = ..., snapRelative: bool = ..., snapValue: Queryable[float] = ..., tweakMode: bool = ...) -> Union[str, bool, float]:
    ...
    Args:
        editPivotMode (bool?): Returns true when manipulator is in edit pivot mode.  
                Properties: query
        ...
        position (bool?): Returns the current position of the manipulator.  
                Properties: query
        preventNegativeScale (bool?): Prevent negative scale for components.  
