...
class MFnPlugin(maya.OpenMaya.MFnBase):
    ...
    def deregisterAnimCurveInterpolator(
    ...
    def deregisterConstraintCommand(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def deregisterModelEditorCommand(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def deregisterTopologyEvaluator(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def deregisterURIFileResolver(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    @staticmethod
    ...
    def registerAnimCurveInterpolator(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def registerModelEditorCommand(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPx3dModelView:
    ...
    def setCurrentCameraSetCamera(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def setCustomDrawEnable(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def setDestroyOnPanelDestruction(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxConstraint(MPxNode):
    ...
    @staticmethod
    def className(*args: Unknown, **kwargs: Unknown) -> Any: ...
    def constraintRotateOrderAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxConstraintCommand(MPxCommand):
    ...
    def connectObjectAndConstraint(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def connectTarget(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def constraintEnableRestAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def constraintInstancedAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def constraintNode(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def constraintOutputAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def constraintRestAttribute(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def constraintTargetAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def constraintTargetInstancedAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def constraintTargetWeightAttribute(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxDeformerNode(MPxGeometryFilter):
    ...
    def setUseExistingConnectionWhenSetEditing(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    thisown: bool
    def type(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
...
class MPxEmitterNode(MPxNode):
    ...
    thisown: bool
    def type(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def volumePrimitiveBoundingBox(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def volumePrimitiveDistanceFromAxis(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def volumePrimitivePointInside(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxFileTranslator:
    ...
    def __repr__(self) -> Any: ...
    def __swig_destroy__(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def allowMultipleFileOptimization(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxIkSolverNode(MPxNode):
    ...
    def isAttributeCreatedBySolver(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxRenderPassImpl:
    ...
    def perLightPassContributionSupported(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    thisown: Any
...
class MPxSurfaceShape(MPxNode):
    ...
    def extendSelectionFromComponents(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
...
class MPxTransform(MPxNode):
    ...
    def _dirtyRotatePivotTranslation(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def applyScaleLocksPivotTranslate(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    boundingBoxCenterZ: maya.OpenMaya.MObject
    center: maya.OpenMaya.MObject
    def checkAndSetRotateOrientation(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def checkAndSetRotatePivot(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def checkAndSetRotatePivotTranslation(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def checkAndSetScalePivotTranslation(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    ...
    def compute(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
    def computeLocalTransformation(
        self, /, *args: Unknown, **kwargs: Unknown
    ) -> Any: ...
    def copyInternalData(self, /, *args: Unknown, **kwargs: Unknown) -> Any: ...
...
class MPxTransformationMatrix:
    ...
    @staticmethod
    def convertTransformationRotationOrder(
